...
export default function CancellationEmail(props: CancelEmailProps) {
  return (
    <Html>
      <Head />
      <Preview>Your schedule is cancelled!</Preview>
      <Tailwind>
          ...
          <Container className="border border-solid border-[#eaeaea] rounded my-[40px] mx-auto p-[20px] w-[465px] font-sans">
            ...
            <Container className="text-center mb-5">
              <Section className="mb-3">
                ...
                <Heading as="h2">Your schedule is cancelled!</Heading>
              </Section>
              ...
              <Section className="text-center">
                <Text>
                  For some reason, your schedule has been cancelled. If you wish
                  to re-schedule, please refer to the links below.
                </Text>
